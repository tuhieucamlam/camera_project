...
from pyModbusTCP.client import ModbusClient #pip install pyModbusTCP pip install pyModbusTCP
from pymodbus.client.sync import ModbusSerialClient #https://github.com/riptideio/pymodbus pip install "pymodbus==2.3.0"
